...
# ERP 전용 화면
# ──────────────────────────────────────────
st.session_state.setdefault("current_tab", "delivery")
st.markdown("""
<div style="margin-bottom:8px;">
    <div style="font-size:32px;font-weight:900;color:#111827;line-height:1.1;">🏭 대봉 ERP</div>
    <div style="font-size:20px;font-weight:700;color:#6b7280;margin-top:4px;">거래처 · 출고일지 · 기사 · 경비 관리</div>
</div>
""", unsafe_allow_html=True)
st.divider()
tab_delivery = st.container()
with tab_delivery:
